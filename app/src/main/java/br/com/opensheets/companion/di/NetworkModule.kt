...
import br.com.opensheets.companion.data.remote.interceptors.AuthInterceptor
import br.com.opensheets.companion.data.remote.interceptors.DynamicUrlInterceptor
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideOpenSheetsApi(retrofit: Retrofit): OpenSheetsApi {
        return retrofit.create(OpenSheetsApi::class.java)
    }
}
